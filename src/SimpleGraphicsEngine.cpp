...
{
  shader_program_IDs.insert(std::pair<std::string,GLuint>("SHADER_PHONG",ShaderLoader::loadShaders("../data/shaders/simple.vert", NULL, NULL, NULL,
                              "../data/shaders/simple.frag" )));
  shader_program_IDs.insert(std::pair<std::string,GLuint>("SHADER_ONE_COLOR",ShaderLoader::loadShaders("../data/shaders/one_color.vert", NULL, NULL, NULL,
                              "../data/shaders/one_color.frag" )));
  shader_program_IDs.insert(std::pair<std::string,GLuint>("SHADER_BACKGROUND",ShaderLoader::loadShaders("../data/shaders/background.vert", NULL, NULL, NULL,
                              "../data/shaders/background.frag" )));
  shader_program_IDs.insert(std::pair<std::string,GLuint>("SHADER_UPDATE_POINT_CLOUD_POSITIONS",ShaderLoader::loadShaders("../data/shaders/point_cloud_programs/quad_passthrough.vert", NULL, NULL, NULL, "../data/shaders/point_cloud_programs/update_positions.frag")));
  shader_program_IDs.insert(std::pair<std::string,GLuint>("SHADER_UPDATE_POINT_CLOUD_VELOCITIES",ShaderLoader::loadShaders("../data/shaders/point_cloud_programs/quad_passthrough.vert", NULL, NULL, NULL, "../data/shaders/point_cloud_programs/update_velocities.frag")));
  shader_program_IDs.insert(std::pair<std::string,GLuint>("SHADER_UPDATE_POINT_CLOUD_ACCELERATIONS",ShaderLoader::loadShaders("../data/shaders/point_cloud_programs/quad_passthrough.vert", NULL, NULL, NULL, "../data/shaders/point_cloud_programs/update_accelerations.frag")));
  shader_program_IDs.insert(std::pair<std::string,GLuint>("SHADER_RENDER_POINT_CLOUD",ShaderLoader::loadShaders("../data/shaders/point_cloud_programs/render.vert", NULL, NULL, NULL, "../data/shaders/point_cloud_programs/render.frag")));
}
...
bool SimpleGraphicsEngine::initialize()
{
  ...
  point_cloud_ = new PointCloudGPU(1000000);
